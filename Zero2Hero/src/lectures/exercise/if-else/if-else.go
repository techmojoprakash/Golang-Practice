...
// 	if role == Contractor && !isWeekDay(today) {
// 		fmt.Print("Contractor is accessGranted ")
// 		accessGranted()
// 	} else if role == Member && isWeekDay(today) {
// 		fmt.Print("Member is accessGranted ")
// 		accessGranted()
// 	} else if role == Guest && (today == Monday || today == Wednesday || today == Friday) {
// 		fmt.Print("Guest is accessGranted ")
// 		accessGranted()
// 	} else if role == Admin || role == Manager {
// 		fmt.Print("Admin & Manager is accessGranted ")
// 		accessGranted()
// 	} else {
// 		accessDenied()
// 	}
